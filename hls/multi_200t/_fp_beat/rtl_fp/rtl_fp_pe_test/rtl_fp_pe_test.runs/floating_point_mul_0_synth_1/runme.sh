...
HD_PWD='/home/steven-studio/systolic-mlir/hls/multi_200t/_fp_beat/rtl_fp/rtl_fp_pe_test/rtl_fp_pe_test.runs/floating_point_mul_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log floating_point_mul_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source floating_point_mul_0.tcl
