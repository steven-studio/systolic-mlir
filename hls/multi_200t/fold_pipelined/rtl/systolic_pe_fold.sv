/*
 * ============================================================
 * Fold-pipelined PE overview
 * ============================================================
 *
 * The K dimension is divided into 8-element folds.
 * Consecutive folds alternate between two accumulator contexts:
 *
 *   fold 0 -> ctx0
 *   fold 1 -> ctx1
 *   fold 2 -> ctx0
 ...
 *   ...
 *
 * Each context owns ACC_BANKS independent accumulator banks:
 *
 *   ctx0: bank0 ... bank15
 *   ctx1: bank0 ... bank15
 *
 * Within a context, incoming MACs are assigned round-robin to banks.
 * This removes the loop-carried dependency on a single accumulator
 * and allows the pipelined FP adder to accept consecutive MAC results.
 *
 * Dataflow:
 *
 *   A/B pair
 ...
 *   acc_bank[ctx][bank]
 *
 * After all K inputs drain, the banks of both contexts are reduced
 * to result_ctx0 and result_ctx1.
 *
 * NOTE:
 * The actual fold number and ctx selection are generated by the
...
module systolic_pe_fold #(
    ...
    */
    ...
    /*
     * ============================================================
     * Stage 0: Fold context + bank assignment
     * ============================================================
     */
