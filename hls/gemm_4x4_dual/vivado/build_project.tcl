# gemm_4x4_dual: SINGLE fixed-point 4x4 array bring-up bitstream.
# Cloned from gemm_4x4/vivado/build_project.tcl; only the HLS source
# paths changed (work_hls_systolic -> work_fx_ii1). The dual-array
# top comes later in this same folder.
set proj_name "matmul_arty_4x4_fx"
