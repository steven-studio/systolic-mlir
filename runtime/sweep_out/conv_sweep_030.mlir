// Auto-generated shape-sweep test case: conv_sweep_030
// N=1 H=10 W=10 Cin=8 Kh=5 Kw=5 Cout=16
// stride=(1,1) dilation=(1,1)
// pad=(top=1,bottom=1,left=1,right=1)
func.func @conv_sweep_030(%input: tensor<1x10x10x8xf32>,
                   %filter: tensor<5x5x8x16xf32>) -> tensor<1x8x8x16xf32> {
  ...
  %out = linalg.conv_2d_nhwc_hwcf
      ...
      ins(%padded, %filter : tensor<1x12x12x8xf32>, tensor<5x5x8x16xf32>)
