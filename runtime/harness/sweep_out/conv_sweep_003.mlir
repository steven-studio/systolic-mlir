// Auto-generated shape-sweep test case: conv_sweep_003
// N=1 H=8 W=8 Cin=3 Kh=5 Kw=5 Cout=8
// stride=(1,1) dilation=(1,1)
// pad=(top=1,bottom=1,left=1,right=1)
func.func @conv_sweep_003(%input: tensor<1x8x8x3xf32>,
                   %filter: tensor<5x5x3x8xf32>) -> tensor<1x6x6x8xf32> {
