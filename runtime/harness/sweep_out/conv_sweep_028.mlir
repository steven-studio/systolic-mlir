// Auto-generated shape-sweep test case: conv_sweep_028
// N=1 H=8 W=8 Cin=1 Kh=3 Kw=3 Cout=1
// stride=(1,1) dilation=(1,1)
// pad=(top=1,bottom=1,left=1,right=1)
func.func @conv_sweep_028(%input: tensor<1x8x8x1xf32>,
                   %filter: tensor<3x3x1x1xf32>) -> tensor<1x8x8x1xf32> {
  ...
  %init = tensor.empty() : tensor<1x8x8x1xf32>
  %out = linalg.conv_2d_nhwc_hwcf
      ...
      outs(%init : tensor<1x8x8x1xf32>) -> tensor<1x8x8x1xf32>
  return %out : tensor<1x8x8x1xf32>
}
