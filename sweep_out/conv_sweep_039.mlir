// Auto-generated shape-sweep test case: conv_sweep_039
// N=1 H=10 W=10 Cin=3 Kh=5 Kw=5 Cout=8
// stride=(2,2) dilation=(1,1)
// pad=(top=1,bottom=1,left=1,right=1)
func.func @conv_sweep_039(%input: tensor<1x10x10x3xf32>,
                   %filter: tensor<5x5x3x8xf32>) -> tensor<1x4x4x8xf32> {
  ...
  %out = linalg.conv_2d_nhwc_hwcf
      ...
      ins(%padded, %filter : tensor<1x12x12x3xf32>, tensor<5x5x3x8xf32>)
      outs(%init : tensor<1x4x4x8xf32>) -> tensor<1x4x4x8xf32>
